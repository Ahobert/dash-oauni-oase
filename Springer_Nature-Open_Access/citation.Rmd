...
```
This figure shows the Percentage of highly cited articles published by corresponding authors from four country groups for different publishing models among scientific fields and genders. Generally, we observe a higher percentage of highly cited papers for corresponding authors from countries with higher income levels.
