...
htmltools::browsable(
  ...
  columns = list(
    ...
    ntotal_gender = colDef(name="Number of all corresponding authors",show=T,minWidth = 130,aggregate = "sum",format = colFormat( separators = TRUE)),
    n_men = colDef(name="Number of male corresponding authors",show=T,minWidth = 130,aggregate = "sum",format = colFormat( separators = TRUE)),
    n_women = colDef(name="Number of male corresponding authors",show=T,minWidth = 130,aggregate = "sum",format = colFormat( separators = TRUE)),
