...
This table gives us an overview of the distribution of researchers by their publishing model and the proportion of each gender among four country groups and scientific fields.  
```{js}
